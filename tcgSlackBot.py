...
def get_all_prices():
    ...
    client.chat_postMessage(channel=channel_id, text='Generating the price list. You will be DM\'d the CSV file shortly.')
    
    # Step 3: Queue the background job
    run_tcg_tracker_and_send.delay(dm_channel_id)
